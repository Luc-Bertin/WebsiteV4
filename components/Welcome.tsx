...
import { FaGithub, FaLinkedin, FaFileAlt, FaChalkboardTeacher } from 'react-icons/fa';
import { SiMalt } from 'react-icons/si';
import { FaArrowRight } from 'react-icons/fa';

const fullText = "Hello, I'm Luc Bertin. A Backend Developer.";
const technologies = [
    'Python','FastAPI', 'Flask', 'Django', 'Hydra', 'Kratos', 'Keto', 'Airflow', 'Docker',
     'Vue.js','AsyncIO', 'Websocket', 'Pydantic', 'Testing', 'CI/CD', 'AWS', 'Django','DRF',  
     'Neo4j', 'Redis', 'SQL', 'Qt','Scraping', 'Selenium', 'R', 'DL/ML', 'Numpy/Pandas'
  ];
            ...
            <div className="flex flex-col md:flex-row items-center justify-between">
              ...
              >
                ...
                <p className="text-3xl mb-12 text-gray-300">
                  Passionate about building robust and scalable backend systems that power the digital world.
                </p>
  
                {/* Buttons Section */}
                <div className="flex flex-wrap justify-start gap-6">
                  {[
                    { href: "https://github.com/Luc-Bertin", icon: FaGithub, label: "GitHub" },
                    { href: "https://www.malt.fr/profile/lucbertin1", icon: SiMalt, label: "Malt" },
                    { href: "https://www.linkedin.com/in/luc-bertin-291904ab/", icon: FaLinkedin, label: "LinkedIn" },
                    { href: "/resume_Luc.pdf", icon: FaFileAlt, label: "Resume/CV" },
                    { href: "https://blog.lucbertin.com/", icon: FaChalkboardTeacher, label: "Classes I Teach" }
                  ].map((link, index) => (
                    <motion.div
                      key={link.label}
                      initial={{ opacity: 0, y: 20 }}
